...
# ================= 数据集生成封装 =================
def build_dataset(num_cases=5, num_stands=20, num_planes=12,
                  base_dir="airport_dataset", seed=42, save_layouts=True):
    random.seed(seed)
...
def parse_args():
    parser = argparse.ArgumentParser(description="Generate HKBZ scheduling cases.")
    parser.add_argument("--output", default="onpolicy/envs/HKBZ/dataset/generated")
    parser.add_argument("--num-cases", type=int, default=20)
    parser.add_argument("--num-stands", type=int, default=20)
    parser.add_argument("--num-planes", type=int, default=12)
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--no-layouts", action="store_true",
                        help="Skip PNG layout rendering for faster generation.")
...
if __name__ == "__main__":
    ...
    build_dataset(
        ...
        num_stands=args.num_stands,
        num_planes=args.num_planes,
        base_dir=args.output,
        seed=args.seed,
        save_layouts=not args.no_layouts,
    )
