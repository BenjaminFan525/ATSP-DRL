...
RUN = WORKSPACE/'result/hkbz_train_logs/stage3_h3_continuation_tau_20260917_r3_env96_gpu0'
UNIT = 'hkbz-stage3-h3-continuation-20260917-r3-env96-gpu0.service'
...
def main():
    ...
    if (m['recipe']['execution_profile'] != 'dual_env96_mb64_no_memory_protection_v1'
            or m['recipe']['rollout_workers'] != 96
    ...
    command = ['systemd-run','--system','--no-ask-password','--unit='+UNIT,
               '--description=H3 C03 T10 env96 GPU0 continuation; experiment memory protection disabled']
