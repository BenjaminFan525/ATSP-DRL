...
> 2026-09-12：本文下方保留历史研究记录，不再代表当前启动流程。
> Stage2 已冻结，训练入口受冻结保护；正式交接见 [STAGE2_FROZEN.md](STAGE2_FROZEN.md)。
> Stage3 为独立的继续研究阶段，保留当前实现，见
> [合并边界](docs/STAGE2_STAGE3_INTEGRATION.md) 与 [全量实验计划](STAGE3_FULL_DATA_20260912.md)。
