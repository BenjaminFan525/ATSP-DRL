...
RUN=WORKSPACE/'result/hkbz_train_logs/stage3_h3_single_parent_20260918_r4_env384_mb128_gpu0'
UNIT='hkbz-stage3-h3-single-parent-20260918-r4-env384-mb128-gpu0.service'
...
def main():
    ...
    if (identity!=q['request_sha256'] or q['root']!=str(RUN) or q['after_epoch']!=2
    ...
    command=['systemd-run','--system','--no-ask-password','--unit='+UNIT,
             '--description=Stage3 wait for epoch2 checkpoint then continue env384 mb128 GPU0']
