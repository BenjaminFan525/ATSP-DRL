...
RUN = WORKSPACE/'result/hkbz_train_logs/stage3_h3_single_parent_20260918_r1_env240_gpu0'
UNIT = 'hkbz-stage3-h3-single-parent-20260918-r1-env240-gpu0.service'
...
def main():
    ...
    if (m['recipe']['execution_profile'] != 'single_parent_v1'
            or m['recipe']['rollout_workers'] != 240
    ...
    command = ['systemd-run','--system','--no-ask-password','--unit='+UNIT,
               '--description=H3 single R0 E8 continuation env240 GPU0; experiment memory protection disabled']
