...
RUN=WORKSPACE/'result/hkbz_train_logs/stage3_h3_r0e8_fresh_20260918_r7_env384_mb192_nopost_gpu0'
...
def main():
    ...
    if (identity!=q['request_sha256'] or q['root']!=str(RUN) or q['after_epoch']!=3
    ...
    command=['systemd-run','--system','--no-ask-password','--unit='+UNIT,
             '--description=Stage3 wait for epoch3 checkpoint then continue env384 mb192 nopost fixed8 GPU0']
